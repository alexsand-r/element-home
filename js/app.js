(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".product-card__image")) if (document.querySelector(".images-product__slider")) {
            ...
            new core(".images-product__slider", {
                modules: [ Navigation, Thumb, Controller, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                grabCursor: true,
                ...
                navigation: {
                    prevEl: ".control-card__left",
                    nextEl: ".control-card__right"
                },
                pagination: {
                    el: ".swiper-pagination",
                    clickable: true
...
***************************************************************************** */
    ...
    function script_initSliders() {
        if (document.querySelector(".clients__slider")) {
            if (window.innerWidth <= 460 && "false" == slider.dataset.mobile) if (document.querySelector(".clients__slider")) {
                mySwiper = new core(".clients__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1.8,
